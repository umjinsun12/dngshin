...
<?php if($__Context->mi->show_comment_write !='Y'){ ?><div class="clearfix"><button class="btOpenWrite"><?php echo $__Context->lang->write_comment ?></button> <a href="<?php echo getUrl('document_srl','') ?>" class="btDark"><?php echo $__Context->lang->cmd_list ?></a></div><?php } ?>
