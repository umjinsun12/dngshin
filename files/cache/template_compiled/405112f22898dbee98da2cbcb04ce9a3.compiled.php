...
<?php if($__Context->module_info){ ?><ul class="x_nav x_nav-tabs">
	...
	<li<?php if($__Context->act=='dispEpayAdminEpayList'){ ?> class="x_active"<?php } ?>><a href="<?php echo getUrl('','module',$__Context->module,'act','dispEpayAdminEpayList') ?>"><?php echo $__Context->lang->page_list ?></a></li>
	<?php if($__Context->module_srl){ ?><li class="x_active"><a href="<?php echo getUrl('','module',$__Context->module,'act','dispEpayAdminInsertEpay') ?>"><?php echo $__Context->module_info->mid ?> <?php echo $__Context->lang->page_management ?></a></li><?php } ?>
	<li<?php if($__Context->act=='dispEpayAdminInsertEpay' && !$__Context->module_srl){ ?> class="x_active"<?php } ?>><a href="<?php echo getUrl('','module',$__Context->module,'act','dispEpayAdminInsertEpay') ?>"><?php echo $__Context->lang->page_creation ?></a></li>
	<li<?php if($__Context->act=='dispEpayAdminPluginList'){ ?> class="x_active"<?php } ?>><a href="<?php echo getUrl('','module',$__Context->module,'act','dispEpayAdminPluginList') ?>"><?php echo $__Context->lang->plugin ?></a></li>
	...
	<li<?php if($__Context->act=='dispEpayAdminInsertPlugin'){ ?> class="x_active"<?php } ?>><a href="<?php echo getUrl('','module',$__Context->module,'act','dispEpayAdminInsertPlugin') ?>"><?php echo $__Context->lang->plugin_creation ?></a></li>
</ul><?php } ?>
