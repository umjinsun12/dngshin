...
require_once('./classes/xml/XmlJsFilter.class.php');$__xmlFilter=new XmlJsFilter('modules/page/tpl/filter','insert_mpage_content.xml');$__xmlFilter->compile(); ?>
...
<form action="./" method="post" id="pageFo" onsubmit="return doSubmitMPageContent(this);"><input type="hidden" name="error_return_url" value="<?php echo htmlspecialchars(getRequestUriByServerEnviroment(), ENT_COMPAT | ENT_HTML401, 'UTF-8', false) ?>" /><input type="hidden" name="vid" value="<?php echo $__Context->vid ?>" />
	...
	<div class="btnArea" id="pageBtnArea" hidden>
		<div class="etc">
			<span class="btn-group">
				...
				<input class="btn" type="button" value="<?php echo $__Context->lang->cmd_content_insert ?>" onclick="doAddContent('<?php echo $__Context->module_info->mid ?>')" />
			</span>
