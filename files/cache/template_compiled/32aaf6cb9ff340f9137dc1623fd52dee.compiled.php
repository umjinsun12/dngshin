...
if (!$__Context->mi->thumb_width) $__Context->mi->thumbnail_width = 96;
 ...
 ?>
<?php $__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/m.skins/bupregBoard','_list_header.html') ?>
...
if($__Context->layout_info->mCol == 'black'){ ?><img src="/modules/board/m.skins/bupregBoard/images/biComment2@2x.png" alt="comment" width="14px" height="12px" class="comment-image" /><?php }else{ ?><img src="/modules/board/m.skins/bupregBoard/images/biComment@2x.png" alt="comment" width="14px" height="12px" class="comment-image" /><?php } ?><a href="<?php echo $__Context->document->getPermanentUrl() ?>#comment" class="reply m-list-reply"><?php echo $__Context->document->getCommentCount() ?></a><?php } ?>
		</li>
		<?php } ?>
...
<?php $__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/m.skins/bupregBoard','_list_footer.html') ?>