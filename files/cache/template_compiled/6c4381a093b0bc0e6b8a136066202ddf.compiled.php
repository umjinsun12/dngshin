	...
	<div class="read-body">
		...
		<?php if($__Context->oDocument->isExtraVarsExists()){ ?>
			...
			<table cellpadding="0" cellspacing="0" class="xv">
				<tr>
					<td colspan="2" style="font-weight: bold;font-size: 120%;">입력값</td>
				</tr>
			<?php if($__Context->_extra_vars[1]->value){ ?>
				<tr>
					<th><?php echo $__Context->_extra_vars[1]->name ?></th>
					<td><?php echo $__Context->_extra_vars[1]->getValueHTML() ?></td>
				</tr>
			<?php } ?>
			<?php if($__Context->_extra_vars[2]->value){ ?>
				<tr>
					<th><?php echo $__Context->_extra_vars[2]->name ?></th>
					<td><?php echo $__Context->_extra_vars[2]->getValueHTML() ?></td>
				</tr>
			<?php } ?>
			...
			<?php } ?>
				<tr>
					<td colspan="2" style="font-weight: bold;font-size: 120%;">결과값</td>
				</tr>
				<?php  
				$__Context->chui = $__Context->_extra_vars[1]->value*10;
				$__Context->gyo = $__Context->_extra_vars[1]->value*10;
				$__Context->jungji = $__Context->_extra_vars[1]->value*10;
				$__Context->inji = $__Context->_extra_vars[1]->value*10;
				$__Context->chae =  $__Context->_extra_vars[1]->value*10;
				$__Context->dggibu =  $__Context->_extra_vars[1]->value*10;
				$__Context->total = $__Context->chui+$__Context->gyo; ?>
				<tr>
					<th><?php echo $__Context->_extra_vars[1]->name ?></th>
					<td><?php echo $__Context->_extra_vars[1]->getValueHTML() ?></td>
				</tr>
				<tr>
					<th>취득세</th>
					<td><?php echo $__Context->chui ?></td>
				</tr>
				<tr>
					<th>교육세</th>
					<td><?php echo $__Context->gyo ?></td>
				</tr>
				<tr>
					<th>증지</th>
					<td><?php echo $__Context->jungji ?></td>
				</tr>
				<tr>
					<th>인지</th>
					<td><?php echo $__Context->inji ?></td>
				</tr>
				<tr>
					<th>채권액</th>
					<td><?php echo $__Context->chae ?></td>
				</tr>
				<tr>
					<th>등기부등본</th>
					<td><?php echo $__Context->dggibu ?></td>
				</tr>
				<tr>
					<th>합계</th>
					<td><?php echo $__Context->total ?></td>
				</tr>
			</table>
		<?php } ?>
...
<div class="read-control">
	...
	<div class="share">
		<!--
		<a href="javascript:sendLink()" id="kakao-link-btn"><img src="/modules/board/m.skins/flatBoard/images/siKakao@2x.png" alt="kakao talk" width="40px" height="40px" /></a>
		<script>
		...
		<script type="text/javascript">
  		...
  		<a onclick="javascript:executeKakaoStoryLink()"><img src="/modules/board/m.skins/flatBoard/images/siKakaoStory@2x.png" alt="kakao story" width="40px" height="40px" /></a>
  		<a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo $__Context->oDocument->getPermanentUrl() ?>"><img src="/modules/board/m.skins/flatBoard/images/siFacebook@2x.png" alt="Facebook" width="40px" height="40px" /></a>
		<a href="http://twitter.com/share?url=<?php echo $__Context->oDocument->getPermanentUrl() ?>&text=<?php echo $__Context->oDocument->getTitle() ?>"><img src="/modules/board/m.skins/flatBoard/images/siTwitter@2x.png" alt="Twitter" width="40px" height="40px" /></a>
	</div>
</div>
<!--<?php $__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/m.skins/flatBoard','comment.html') ?> 잠깐지워보쟝-->
</div>
<?php } ?>
