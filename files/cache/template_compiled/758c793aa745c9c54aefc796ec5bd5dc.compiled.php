...
<?php $__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/dgibi/m.skins/default','_head.html') ?>
      	...
      	<div class="grey-header">
        	...
        	<div class="text-new" style="margin-top:10px"><a class="w-inline-block" href="newitem.html" data-load="1">
...
<a href="<?php echo getUrl('', 'mid', $__Context->mid, 'act', 'dispDgibiWrite') ?>">다음으로 넘어가기</a>