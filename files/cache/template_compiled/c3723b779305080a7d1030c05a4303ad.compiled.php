...
<div style="margin-bottom:20px;">
	<?php if(0){ ?><a href="<?php echo getUrl('','module',$__Context->module,'act',$__Context->act,'status','0') ?>"<?php if($__Context->status=='0'){ ?> class="active"<?php } ?>><?php echo $__Context->lang->cmd_cart ?></a><?php } ?> <i>|</i>
	<a href="<?php echo getUrl('','module',$__Context->module,'act',$__Context->act,'status','1') ?>"<?php if($__Context->status=='1'){ ?> class="active"<?php } ?>><?php echo $__Context->lang->wait_deposit ?></a> <i>|</i>
	<a href="<?php echo getUrl('','module',$__Context->module,'act',$__Context->act,'status','2') ?>"<?php if($__Context->status=='2'){ ?> class="active"<?php } ?>><?php echo $__Context->lang->deposit_done ?></a> <i>|</i>
	<a href="<?php echo getUrl('','module',$__Context->module,'act',$__Context->act,'status','3') ?>"<?php if($__Context->status=='3'){ ?> class="active"<?php } ?>><?php echo $__Context->lang->prepare_delivery ?></a> <i>|</i>
	<a href="<?php echo getUrl('','module',$__Context->module,'act',$__Context->act,'status','4') ?>"<?php if($__Context->status=='4'){ ?> class="active"<?php } ?>><?php echo $__Context->lang->on_delivery ?></a> <i>|</i>
	<a href="<?php echo getUrl('','module',$__Context->module,'act',$__Context->act,'status','5') ?>"<?php if($__Context->status=='5'){ ?> class="active"<?php } ?>><?php echo $__Context->lang->delivery_done ?></a> <i>|</i>
	<a href="<?php echo getUrl('','module',$__Context->module,'act',$__Context->act,'status','6') ?>"<?php if($__Context->status=='6'){ ?> class="active"<?php } ?>><?php echo $__Context->lang->transaction_done ?></a> <i>|</i>
	<a href="<?php echo getUrl('','module',$__Context->module,'act',$__Context->act,'status','A') ?>"<?php if($__Context->status=='A'){ ?> class="active"<?php } ?>><?php echo $__Context->lang->cancelled ?></a> <i>|</i>
	<a href="<?php echo getUrl('','module',$__Context->module,'act',$__Context->act,'status','B') ?>"<?php if($__Context->status=='B'){ ?> class="active"<?php } ?>><?php echo $__Context->lang->returns ?></a> <i>|</i>
	<a href="<?php echo getUrl('','module',$__Context->module,'act',$__Context->act,'status','C') ?>"<?php if($__Context->status=='C'){ ?> class="active"<?php } ?>><?php echo $__Context->lang->exchanges ?></a> <i>|</i>
	<a href="<?php echo getUrl('','module',$__Context->module,'act',$__Context->act,'status','D') ?>"<?php if($__Context->status=='D'){ ?> class="active"<?php } ?>><?php echo $__Context->lang->refund ?></a> <i>|</i>
</div>
...
echo $__Context->order->invoice_no ?>" target="_blank"><span><?php echo $__Context->lang->cmd_trace_delivery ?></span></a><?php } ?>
					...
					<td><a href="#viewOrderInfo" class="modalAnchor viewOrderInfo" data-order-srl="<?php echo $__Context->order->order_srl ?>"><?php echo $__Context->lang->title_order_info ?></a></td>
					<td>
