...
<?php if($__Context->document_srl){ ?><!--#Meta:modules/board/m.skins/gwangBoard/js/edit.js--><?php $__tmp=array('modules/board/m.skins/gwangBoard/js/edit.js','','','');Context::loadFile($__tmp);unset($__tmp);
} ?>
