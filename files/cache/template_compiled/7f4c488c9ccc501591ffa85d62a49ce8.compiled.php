...
<!--#Meta:widgets/widget_maplist/skins/widget_maplist_daummap_skin/css/widget.css--><?php $__tmp=array('widgets/widget_maplist/skins/widget_maplist_daummap_skin/css/widget.css','','','');Context::loadFile($__tmp);unset($__tmp); ?>
<?php if(Mobile::isMobileCheckByAgent() || $__Context->m==1){ ?>
<!--#Meta:widgets/widget_maplist/skins/widget_maplist_daummap_skin/css/m_widget.css--><?php $__tmp=array('widgets/widget_maplist/skins/widget_maplist_daummap_skin/css/m_widget.css','','','');Context::loadFile($__tmp);unset($__tmp); ?>
<?php } ?>
  ...
  <div class="map_list_wrap"<?php if(!(Mobile::isMobileCheckByAgent() || $__Context->m==1)){ ?> style="height:<?php echo $__Context->map_obj->map_height-2 ?>px;"<?php } ?>>
    <ul class="map_list">
      ...
      <?php if($__Context->map_list&&count($__Context->map_list))foreach($__Context->map_list as $__Context->key => $__Context->val){ ?>
        ...
        <?php if($__Context->val->map_latitude && $__Context->val->map_longitude){ ?><li class="list_<?php echo $__Context->map_document->document_srl ?> list<?php echo $__Context->count ?> list list-message" id="<?php echo $__Context->val->document_srl ?>">
          ...
          <a class="link w-clearfix w-inline-block" href="#map" onclick="markerClickEvent(jQuery(this).parent().attr('id')); return false;">
            ...
            <div class="image-message" style="margin-right: 5px">
            	<img style="width: 50px;height: 50px" src="<?php echo $__Context->map_document->getThumbnail($__Context->map_obj->thumbnail_width,$__Context->map_obj->thumbnail_height) ?>" />
            </div>
            </div>
            <?php }else{ ?>
            <div class="thumbnail" style="height:<?php echo $__Context->link_thumbnail_height ?>px;">
            	<img src="<?php echo $__Context->skin_path ?>images/noimage.gif" style="width:<?php echo $__Context->link_thumbnail_width ?>px; height:<?php echo $__Context->link_thumbnail_height ?>px;" />
            </div>
            <?php } ?>
            <div class="column-right introd">
            	<div class="message-title">
            		<?php echo $__Context->map_document->getTitle(25) ?> 법무사
            	</div>
            	<div class="message-text">
            		<?php echo $__Context->map_document->getExtraEidValueHTML('map_address') ?>
            	</div>
            </div>
          </a>
          ...
          <div class="map_attribute<?php echo $__Context->count ?> map_attribute" id="map_attribute_<?php echo $__Context->map_document->document_srl ?>" style="display:none;">
            ...
            <div class="info_content_html" id="info_content_html_<?php echo $__Context->map_document->document_srl ?>">
              <div class="map_info_content" id="map_info_content_<?php echo $__Context->map_document->document_srl ?>" style="width:<?php echo $__Context->map_obj->info_content_width ?>px;<?php if($__Context->map_obj->info_content_height){ ?> height:<?php echo $__Context->map_obj->info_content_height ?>px;<?php } ?>">
                <a class="title_area" href="<?php echo getUrl('','document_srl',$__Context->map_document->document_srl) ?>"><span class="title message-title" style="font-size: 15px"><?php echo addslashes($__Context->map_document->getTitle($__Context->map_obj->subject_cut_size)) ?></span><span> 법무사</span></a>
                <div class="content_area">
                  ...
                  <?php } ?>
                    <span class="content" >
                    	...
                    	<div class="message-text" style="height:<?php echo $__Context->map_obj->thumbnail_height ?>-10px">
	                    	<?php echo addslashes($__Context->map_document->getSummary($__Context->map_obj->content_cut_size)) ?>                    	
                    	</div>
                    </span>				
                </div>
			...
			<div  style="text-align: center; margin-bottom: 10px">              
              <a class="title_area small-button" href="<?php echo getUrl('','document_srl',$__Context->map_document->document_srl) ?>">
                	<span class="title">
                		상세보기/견적문의
                	</span>
              </a>
  ...
  jQuery('.<?php echo $__Context->skin_topdiv_class ?> .map_list_wrap .map_list .list').each(function(docu_srl){
    ...
    if(navigator.geolocation) {
      navigator.geolocation.getCurrentPosition(function(position) {
        ...
        jQuery('.<?php echo $__Context->skin_topdiv_class ?> .map_list_wrap .map_list .list_'+docu_srl+' .link .introd').append('<span class="distance" style="display:inline-block;font-size:12px;">거리 : '+rtn+'</span>');
      });
    }
    //마커 및 정보창 설정
    if(!markers[docu_srl]){
