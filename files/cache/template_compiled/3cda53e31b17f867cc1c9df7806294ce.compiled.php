<?php if(!defined("__XE__"))exit;?><input type="hidden" name="join_form_id_list" value="<?php echo $__Context->id_list ?>" />
<input type="hidden" name="old_column_id" value="<?php echo $__Context->formInfo->column_name ?>" />
	<input type="hidden" name="member_join_form_srl" value="<?php echo $__Context->formInfo->member_join_form_srl ?>" />
	...
	<div class="x_modal-body">
		<div class="x_control-group">
			...
			<div class="x_controls">
				<input type="text" id="column_id" name="column_id" value="<?php echo $__Context->formInfo->column_name ?>" />
		...
		<div class="x_control-group">
			...
			<div class="x_controls">
				<input type="text" id="column_title" name="column_title" value="<?php echo $__Context->formInfo->column_title ?>" />
			</div>
		</div>
		<div class="x_control-group">
			...
			<div class="x_controls">
				<select id="columnType" class="typeSelect" name="column_type">
					<?php if($__Context->lang->column_type_list&&count($__Context->lang->column_type_list))foreach($__Context->lang->column_type_list as $__Context->key=>$__Context->type_info){ ?><option value="<?php echo $__Context->key ?>"<?php if($__Context->formInfo->column_type == $__Context->key){ ?> selected="selected"<?php } ?> ><?php echo $__Context->lang->column_type_list[$__Context->key] ?></option><?php } ?>
				</select>
			</div>
		</div>
...
echo implode('<enter>', $__Context->default_value);
} ?></textarea>
		...
		<div class="x_control-group">
			...
			<div class="x_controls">
				<textarea rows="4" cols="42" id="desc" name="description"><?php echo $__Context->formInfo->description ?></textarea>
			</div>
		</div>
		<div class="x_control-group">
