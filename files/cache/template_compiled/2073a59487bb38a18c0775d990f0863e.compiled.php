...
if($__Context->val1['selected']){ ?>
	<span>&rsaquo;</span><a href="<?php echo $__Context->val1['href'] ?>"><?php if(!$__Context->val1['list']){ ?><em><?php echo $__Context->val1['text'] ?></em><?php }else{;
...
if($__Context->val2['selected']){ ?>
	<span>&rsaquo;</span><a href="<?php echo $__Context->val2['href'] ?>"><?php if(!$__Context->val2['list']){ ?><em><?php echo $__Context->val2['text'] ?></em><?php }else{;
...
if($__Context->val3['selected']){ ?>
	<span>&rsaquo;</span><a href="<?php echo $__Context->val3['href'] ?>"><?php if(!$__Context->val3['list']){ ?><em><?php echo $__Context->val3['text'] ?></em><?php }else{;
