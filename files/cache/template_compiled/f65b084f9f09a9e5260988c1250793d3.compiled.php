<?php if(!defined("__XE__"))exit;?><!--#Meta:modules/board/skins/test_board/board.default.css--><?php $__tmp=array('modules/board/skins/test_board/board.default.css','','','');Context::loadFile($__tmp);unset($__tmp); ?>
<!--#Meta:modules/board/skins/test_board/board.default.js--><?php $__tmp=array('modules/board/skins/test_board/board.default.js','body','','');Context::loadFile($__tmp);unset($__tmp); ?>
