...
$__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/igrusboard/skins/default','_head.html') ?>
<table>
	...
	<a href="<?php echo getUrl('', 'mid', $__Context->mid, 'act', 'dispIgrusboardWrite') ?>"><?php echo $__Context->lang->cmd_write ?></a>
