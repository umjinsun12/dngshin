...
<?php if($__Context->document_srl){ ?><!--#Meta:modules/board/m.skins/flatBoard/js/edit.js--><?php $__tmp=array('modules/board/m.skins/flatBoard/js/edit.js','','','');Context::loadFile($__tmp);unset($__tmp);
} ?>
...
echo $__Context->lang->cmd_write;
	...
	<input type="hidden" name="document_srl" value="<?php echo $__Context->document_srl ?>" />
		<ul>
			...
			<li><label for="nText">설명 <em>*</em></label>
				<textarea name="content" rows="2" cols="12" id="nText"><?php if($__Context->document_srl){;
