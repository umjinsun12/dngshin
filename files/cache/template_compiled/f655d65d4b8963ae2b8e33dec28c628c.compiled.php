...
$__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/test_board','_header.html') ?>
<?php if($__Context->oDocument->isExists()){;
$__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/test_board','_read.html');
} ?>
...
<div class="list_footer">
	...
	<div class="btnArea">
		<a href="<?php echo getUrl('act','dispBoardWrite','document_srl','') ?>" class="btn"><?php echo $__Context->lang->cmd_write ?></a>
...
<?php $__tpl=TemplateHandler::getInstance();echo $__tpl->compile('modules/board/skins/test_board','_footer.html') ?>
