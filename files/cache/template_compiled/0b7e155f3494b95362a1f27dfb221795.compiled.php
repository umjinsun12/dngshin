...
<?php if($__Context->module_info){ ?><ul class="x_nav x_nav-tabs">
	<li<?php if($__Context->act=='dispNstoreAdminOrderManagement'){ ?> class="x_active"<?php } ?> ><a href="<?php echo getUrl('','module',$__Context->module,'act','dispNstoreAdminOrderManagement') ?>"><?php echo $__Context->lang->order_management ?></a></li>
	<?php if($__Context->order_srl){ ?><li<?php if($__Context->act=='dispNstoreAdminOrderDetail'){ ?> class="x_active"<?php } ?> ><a href="<?php echo getUrl('','module',$__Context->module,'act','dispNstoreAdminOrderDetail','order_srl',$__Context->order_srl) ?>"><?php echo $__Context->lang->order_details ?></a></li><?php } ?>
	<li<?php if($__Context->act=='dispNstoreAdminModInstList'){ ?> class="x_active"<?php } ?> ><a href="<?php echo getUrl('','module',$__Context->module,'act','dispNstoreAdminModInstList') ?>"><?php echo $__Context->lang->page_list ?></a></li>
	<?php if($__Context->module_srl){ ?><li class="x_active"><a href="<?php echo getUrl('act','dispNstoreAdminItemList') ?>"><?php echo $__Context->module_info->mid ?> <?php echo $__Context->lang->page_management ?></a></li><?php } ?>
	<li<?php if($__Context->act=='dispNstoreAdminInsertModInst' && !$__Context->module_srl){ ?> class="x_active"<?php } ?>><a href="<?php echo getUrl('','module',$__Context->module,'act','dispNstoreAdminInsertModInst') ?>"><?php echo $__Context->lang->page_creation ?></a></li>
	<li<?php if($__Context->act=='dispNstoreAdminConfig'){ ?> class="x_active"<?php } ?>><a href="<?php echo getUrl('','module',$__Context->module,'act','dispNstoreAdminConfig') ?>"><?php echo $__Context->lang->basic_setting ?></a></li>
</ul><?php } ?>
