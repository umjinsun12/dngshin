...
${'message_type2_argument'}->ensureDefaultValue('S');
...
new Table('`dbigrus_member_message`', '`message`')
,new Table('`dbigrus_member`', '`member`')
));
$query->setConditions(array(
new ConditionGroup(array(
new ConditionWithArgument('`message`.`sender_srl`',$member_srl1_argument,"equal")
,new ConditionWithArgument('`message`.`message_type`',$message_type2_argument,"equal", 'and')
,new ConditionWithoutArgument('`message`.`receiver_srl`','`member`.`member_srl`',"equal", 'and')))
));
