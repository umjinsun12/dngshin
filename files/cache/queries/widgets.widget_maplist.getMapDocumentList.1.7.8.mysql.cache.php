...
$query = new Query();
$query->setQueryId("getMapDocumentList");
...
if(isset($args->min_map_latitude)) {
${'min_map_latitude29_argument'} = new ConditionArgument('min_map_latitude', $args->min_map_latitude, 'more');
${'min_map_latitude29_argument'}->createConditionValue();
if(!${'min_map_latitude29_argument'}->isValid()) return ${'min_map_latitude29_argument'}->getErrorMessage();
} else
${'min_map_latitude29_argument'} = NULL;if(isset($args->max_map_latitude)) {
${'max_map_latitude30_argument'} = new ConditionArgument('max_map_latitude', $args->max_map_latitude, 'below');
${'max_map_latitude30_argument'}->createConditionValue();
if(!${'max_map_latitude30_argument'}->isValid()) return ${'max_map_latitude30_argument'}->getErrorMessage();
} else
${'max_map_latitude30_argument'} = NULL;if(isset($args->min_map_longitude)) {
${'min_map_longitude31_argument'} = new ConditionArgument('min_map_longitude', $args->min_map_longitude, 'more');
${'min_map_longitude31_argument'}->createConditionValue();
if(!${'min_map_longitude31_argument'}->isValid()) return ${'min_map_longitude31_argument'}->getErrorMessage();
} else
${'min_map_longitude31_argument'} = NULL;if(isset($args->max_map_longitude)) {
${'max_map_longitude32_argument'} = new ConditionArgument('max_map_longitude', $args->max_map_longitude, 'below');
${'max_map_longitude32_argument'}->createConditionValue();
if(!${'max_map_longitude32_argument'}->isValid()) return ${'max_map_longitude32_argument'}->getErrorMessage();
} else
${'max_map_longitude32_argument'} = NULL;
...
,new ConditionGroup(array(
new ConditionWithArgument('`map_latitude`',$min_map_latitude29_argument,"more", 'and')
,new ConditionWithArgument('`map_latitude`',$max_map_latitude30_argument,"below", 'and')),'and')
,new ConditionGroup(array(
new ConditionWithArgument('`map_longitude`',$min_map_longitude31_argument,"more", 'and')
,new ConditionWithArgument('`map_longitude`',$max_map_longitude32_argument,"below", 'and')),'and')
));
