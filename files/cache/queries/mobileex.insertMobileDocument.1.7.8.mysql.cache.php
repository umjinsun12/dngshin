...
$query = new Query();
$query->setQueryId("insertMobileDocument");
...
${'is_mobile35_argument'} = new Argument('is_mobile', $args->{'is_mobile'});
${'is_mobile35_argument'}->ensureDefaultValue('Y');
if(!${'is_mobile35_argument'}->isValid()) return ${'is_mobile35_argument'}->getErrorMessage();
if(${'is_mobile35_argument'} !== null) ${'is_mobile35_argument'}->setColumnType('char');
...
,new InsertExpression('`is_mobile`', ${'is_mobile35_argument'})
));
