...
if(${'site_srl292_argument'} !== null) ${'site_srl292_argument'}->setColumnType('number');
...
,new JoinTable('`dbigrus_modules`', '`modules`', "left join", array(
...
new ConditionGroup(array(
new ConditionWithArgument('`sites`.`site_srl`',$site_srl292_argument,"equal")))
));
