<?php
   ...
   echo "{
   	\"no\":$row[no]
   ,\"bub_phone\":\"$row[bub_phone]\"
   ,\"mem_phone\":\"$row[mem_phone]\"
   ,\"dgi_chui\":\"$row[dgi_chui]\"
   ,\"dgi_edu\":\"$row[dgi_edu]\"
   ,\"dgi_jungji\":\"$row[dgi_jungji]\"
   ,\"dgi_inji\":\"$row[dgi_inji]\"
   ,\"dgi_chae\":\"$row[dgi_chae]\"
   ,\"dgi_dgibu\":\"$row[dgi_dgibu]\"
   ,\"dgi_total\":\"$row[dgi_total]\"
   }";
