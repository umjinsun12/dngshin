<?php
    ...
    class store_reviewController extends store_review {
        ...
        function insertReview($obj, $manual_inserted = false) {
            ...
            if(!$item_srl) return new Object(-1,'msg_invalid_item');
            ...
            if(!$obj->review_srl) $obj->review_srl = getNextSequence();
            // determine the order
...
*/
        ...
        function deleteReview($review_srl, $is_admin = false, $isMoveToTrash = false) {
            ...
            if($comment->review_srl != $review_srl) return new Object(-1, 'msg_invalid_request');
