...
if($__Context->key == 'php_version'){ ?>(Ver. <?php echo $__Context->phpversion ?>)<?php } ?></strong> 
		...
		<div class="ibtnArea">
			<span class="x_pull-left">
				<a href="<?php echo getUrl('', 'act','dispInstallLicenseAgreement') ?>" class="x_btn x_btn-small x_btn-inverse"><i class="x_icon-chevron-left x_icon-white"></i> <?php echo $__Context->lang->cmd_back ?></a>
			</span>
